...
- **Usernames people choose** stay off general words (faq, services, about-us, pricing, work, tasks, contact…, in any dressing: `our-services`, `servicespage`, `faqs`, `services2`), brand and payment names, and anything that reads as Jhino or its staff (`server/reserved.ts`). A super admin can still give any of them. A username can be changed once in 30 days; the old one is free for anyone at once.
