...
- **Two-step sign-in** (Account → Security): a code from an authenticator app after the password (or Google/Apple), with 8 single-use recovery codes. The secret is stored encrypted. Super admins are asked to turn it on, and their sessions end after 3 days.
