...
- **Email codes.** Confirming an email, resetting a password and changing an email each send a 6-digit code with the link; either works. Five wrong tries lock a code.
